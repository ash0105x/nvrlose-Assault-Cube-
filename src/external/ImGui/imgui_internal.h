...
{
    float   x;
    constexpr const ImVec1()         : x(0.0f) { }
    constexpr const ImVec1(float _x) : x(_x) { }
};
...
{
    short   x, y;
    constexpr const ImVec2ih()                           : x(0), y(0) {}
    constexpr const ImVec2ih(short _x, short _y)         : x(_x), y(_y) {}
    constexpr const explicit ImVec2ih(const ImVec2& rhs) : x((short)rhs.x), y((short)rhs.y) {}
};
...
struct IMGUI_API ImRect
{
    ...
    constexpr const ImRect()                                        : Min(0.0f, 0.0f), Max(0.0f, 0.0f)  {}
    constexpr const ImRect(const ImVec2& min, const ImVec2& max)    : Min(min), Max(max)                {}
    constexpr const ImRect(const ImVec4& v)                         : Min(v.x, v.y), Max(v.z, v.w)      {}
    constexpr const ImRect(float x1, float y1, float x2, float y2)  : Min(x1, y1), Max(x2, y2)          {}
